...
export class Ascii extends Hardware{
    ...
    /*******************************************************************
     * AsciiDecoder is function that maps hex numbers to string characters
    ********************************************************************/
    static AsciiDecoder(key: number): string {
        //this.AsciiTable(key);
        let myMap = new Map<number, string>([
            ...
            [0x2F, "/"], [0x5B, "["], [0x5C, "\\"], [0x5D, "]"], [0x5E, "^"], [0x5F, "_"], [0x60, "\'"],
            [0x7B, "{"], [0x7C, "|"], [0x7D, "}"], [0x7E, "~"], [0x0A, "\n"], 
            // numbers 
